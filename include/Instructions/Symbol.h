...
namespace hackasm {
    struct Symbol {
        std::string label; //actual text from the source
        ...
        Symbol(std::string _label, int _line, int _inst) : label(std::move(_label)), line_loc(_line), inst_loc(_inst),
                                                           value(-1) {}

        Symbol(std::string _label, int _v, int _line, int _inst) : label(std::move(_label)), line_loc(_line),
